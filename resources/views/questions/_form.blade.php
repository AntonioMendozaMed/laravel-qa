...
<div class="form-group">
    ...
    <textarea name="body" id="question-body" value="{{ old('body', $question->body) }}" rows="10" class="form-control {{ $errors->has('body') ? 'is-invalid' : '' }}">{{ old('body', $question->body) }}</textarea>
